...
<html>
  ...
  <body>
    <a href="#create-idUser" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
    <div class="navmenu" role="navigation">
      ...
      <div id="create-idUser" class="content scaffold-create" role="main">
