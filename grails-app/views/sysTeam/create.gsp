...
<html>
  ...
  <body>
    <a href="#create-idApp" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
    <div class="nav" role="navigation">
      ...
      <div id="create-idApp" class="content scaffold-create" role="main">
